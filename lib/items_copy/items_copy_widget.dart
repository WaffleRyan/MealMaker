...
import 'items_copy_model.dart';
export 'items_copy_model.dart';

class ItemsCopyWidget extends StatefulWidget {
  const ItemsCopyWidget({super.key});

  @override
  State<ItemsCopyWidget> createState() => _ItemsCopyWidgetState();
}

class _ItemsCopyWidgetState extends State<ItemsCopyWidget> {
  late ItemsCopyModel _model;
